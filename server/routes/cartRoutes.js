...
async function getCard(userId, guestId){
    if(userId){
...
// @ route POST /api/cart
// @ desc Add a product to the cart for a guest or logged user
// @ access Public
router.post("/", async (req,res)=>{
    ...
    try {
        ...
        let cart = await getCard(userId, guestId);
...
// @ route GET /api/cart
// @ desc Get logged-in user's or guest user's cart (Cart Details)
// @ access Public

router.get("/", async(req,res)=>{
    const {userId, guestId} =  req.query;
    try {
        const cart = await getCard(userId, guestId);
...
router.post("/merge", protect, async(req, res)=>{
    ...
    try {
        ...
        const userCart = await Cart.findOneAndDelete({user: userId});
