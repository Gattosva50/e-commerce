    ...
    <section className='py-16 px-4 lg:px-0'>
        <div className='container mx-auto flex flex-col md:flex-row gap-8'>
            ...
            <div className='relative flex-1'>
                <img src={womenCollectionImg} alt="womenColeectImg" className='w-full h-[700px] object-cover' />
            ...
            {/* Men Collection*/}
            <div className='relative flex-1'>
                <img src={menCollectionImg} alt="menColeectImg" className='w-full h-[700px] object-cover' />
