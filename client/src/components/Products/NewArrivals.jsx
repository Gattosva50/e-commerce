  ...
  function handleMouseUpOrLeave(){
    ...
    function updateScrollButtons(){
        ...
        if(container){
            ...
            setCanScrollRight(leftScroll < 2317.5)
        }
        /*console.log({
    ...
    <section className='py-16 px-4 lg:px-0'>
        <div className='container mx-auto text-center mb-10 relative'>
            ...
            <div className='absolute right-0 bottom-[-30px] flex space-x-2'>
                ...
                <button onClick={()=>scroll('rigth')} disabled={!canScrollRight}
        ...
        {/* Scrollable Images */}
        <div className={`container mx-auto overflow-x-scroll flex space-x-6 relative ${isDragging ? 'cursor-grabbing':'cursor-grab'}`} 
            ref={scrollRef}
