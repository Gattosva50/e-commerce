...
const Checkout = () => {
    ...
    function handlePaymentSuccess(details){
        console.log("Payment Sucdessful", details);
        ...
        <div className='bg-white rounded-lg p-6'>
            ...
            <form onSubmit={handleCreateCheckout}>
                ...
                <div className='mb-4 grid grid-cols-2 gap-4'>
                    <div>
                        <label className='block text-shadow-gray-700'>First Name</label>
                    ...
                    <div>
                        <label className='block text-shadow-gray-700'>Last Name</label>
                ...
                <div className='mb-4 grid grid-cols-2 gap-4'>
                    <div>
                        <label className='block text-shadow-gray-700'>City</label>
                    ...
                    <div>
                        <label className='block text-shadow-gray-700'>Postal Code</label>
